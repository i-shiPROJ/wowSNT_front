<template>
  <div>
    <el-dialog v-if="dialogFormVisible" v-model="dialogFormVisible"
      ...
      <el-form ref="formRef" style="width: 100%" :model="currentSolutionObject" :label-position="labelPosition"
        ...
        <div class="area-task">
          ...
          <el-row>
            <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
              <Wow-file-viewer :files="currentSolutionObject.regRequest.files"
                :folder="currentSolutionObject.regRequest.id.toString()" typeUrl="register-request" />
